...
class authController {
  ...
  async forgotPassword(req, res, next) {
    try {
      ...
      console.log('====================================')
      console.log(token, new Date(tokenExpires))
      console.log('====================================')
                  ...
                  <table cellpadding="0" cellspacing="0" style="margin-top: 30px;">
                    <tr>
                      <td align="center" bgcolor="#ffffff" style="padding: 10px;">
                        <a href="http://185.36.188.161:5173/?token=${token}&email=${email}" style="background-color: #3498db; color: #ffffff; display: inline-block; font-size: 16px; padding: 10px 20px; text-decoration: none;">Reset Password</a>
                      </td>
                    </tr>
                  </table>
                </td>
